        ...
        while True:
            ...
            for r in latest:
                data_to_send = {
                    ...
                    "Scope1Sources": r.get(
                        "scope1_sources", {"Fleet Vehicles": 0, "Boilers": 0, "Generators": 0}
                    ),
                    "Scope2": r.get("scope2", 0),
                    "Scope3": r.get("scope3", 0),
                    "Scope3Sources": r.get(
                        "scope3_sources", {"Purchased Goods": 0, "Business Travel": 0, "Waste Disposal": 0}
                    ),
                    "FuelLevel": r.get(
                        "fuel", {"Diesel Tank": 0, "Gas Tank #2": 0, "Kerosene Res.": 0}
                    ),
                    "Total": r.get("total", 0),
